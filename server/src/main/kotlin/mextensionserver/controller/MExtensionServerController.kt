            ...
            when (session.uri) {
                ...
                "/capabilities" ->
                    newFixedLengthResponse(
                        Response.Status.OK,
                        "application/json",
                        """{"mangatanMihonBridge":1,"animeSeasons":true,"animeHosters":true,"sourceFactory":true,"preferenceCallbacks":true,"imageProxy":true,"videoProxy":true,"youtubeResolver":true,"sourceUrls":true,"extensionHandles":true,"extensionInfo":true}""",
                    )
                "/stop" -> {
